...
/**
 * In this enumeration you can find all possible types of {@link SearchRule} that can be used
 * in JSON objects and by which corresponding elements can be found on the HTML page
 */
