...
public class JsonSchemaValidatorTest {
    ...
    private List<RawSearchRule> rawSearchRules = Lists
            .newArrayList(RawSearchRuleTestDataBuilder.getCommonSearchRule_UniquenessText_SelectorCss(),
                    ...
                    RawSearchRuleTestDataBuilder.getSelenideSearchRule_UniquenessText_SelectorCss(),
                    RawSearchRuleTestDataBuilder.getSelenideSearchRule_UniquenessText_SelectorXpath(),
                    RawSearchRuleTestDataBuilder.getSelenideSearchRule_UniquenessValue_SelectorCss(),
                    RawSearchRuleTestDataBuilder.getSelenideSearchRule_UniquenessValue_SelectorXpath(),
                    RawSearchRuleTestDataBuilder.getSelenideSearchRule_DoesNotPassJsonSchemaValidator()
            );
    ...
    public void validate_RawSearchRules_StatusOk() {
        ...
        assertTrue(rawSearchRules.get(3).isValid());
        assertTrue(rawSearchRules.get(4).isValid());
        assertTrue(rawSearchRules.get(5).isValid());
        assertTrue(rawSearchRules.get(6).isValid());
        assertTrue(rawSearchRules.get(7).isInvalid());
    }
